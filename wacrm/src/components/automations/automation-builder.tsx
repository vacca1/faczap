...
const TRIGGER_OPTIONS: { value: AutomationTriggerType; label: string; hint: string }[] = [
  { value: "new_message_received", label: "Nova Mensagem Recebida", hint: "Qualquer mensagem recebida" },
  {
    ...
    hint: "Primeira vez que este contato envia mensagem (funciona também para contatos adicionados manualmente)",
  },
  { value: "keyword_match", label: "Palavra-chave", hint: "Mensagem contém palavra(s)-chave específica(s)" },
  ...
  { value: "time_based", label: "Agendamento", hint: "Em uma programação recorrente" },
]
...
function previewFor(step: BuilderStep): string {
  switch (step.step_type) {
    ...
    case "send_template":
      return (step.step_config.template_name as string) || "escolha um template"
    case "wait":
