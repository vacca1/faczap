  ...
  return (
    <div className="space-y-6 mt-4">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-lg font-semibold text-white">Membros da conta</h2>
          <p className="text-sm text-slate-400">
            Pessoas com acesso a esta conta. As funções controlam o que cada
            membro pode fazer.
          </p>
        </div>
        ...
        <div>
          ...
          {invitations.length > 0 ? (
            <p className="mb-3 text-xs text-slate-500">
              O link do convite só é exibido uma vez na criação por
            ...
            <Card className="bg-slate-900 border-slate-700 ring-0 ring-transparent">
              <CardContent className="flex flex-col items-center justify-center py-8 text-center">
                ...
                <p className="mt-1 text-xs text-slate-500">
                  Clique em <span className="text-slate-300">Convidar membro</span>{' '}
        ...
        <DialogContent className="bg-slate-900 border-slate-700 sm:max-w-sm">
          <DialogHeader>
            ...
            <DialogDescription className="text-slate-400">
              ...
              da conta? Ele será desconectado desta conta
              e receberá uma nova conta pessoal no próximo login. O
              login não será excluído.
            </DialogDescription>
          </DialogHeader>
