      ...
      <header className="flex items-center justify-between gap-3 border-b border-slate-800 px-5 py-4">
        <div>
          ...
          <p className="mt-0.5 text-xs text-slate-500">
            Minutos para responder a primeira mensagem não respondida de um cliente, por dia da semana
          </p>
        </div>
      ...
      <div className="p-5">
        {loading || !data ? (
          ...
          <EmptyState
            ...
            hint="Este gráfico é preenchido conforme você responde mensagens de clientes."
          />
        ) : (
          <BarChart
            data={chartData}
